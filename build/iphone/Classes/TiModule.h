...
/**
 The base class for all mac_images_uploader modules
 */
...
/**
 mac_images_uploader Platform calls this method on startup.
 */
-(void)startup;

/**
 mac_images_uploader Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 mac_images_uploader Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 mac_images_uploader Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 mac_images_uploader Platform calls this method on resume.
 @param sender The sender of the event.
 */
