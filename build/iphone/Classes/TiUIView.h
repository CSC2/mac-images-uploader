...
/**
 Base class for all mac_images_uploader views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the mac_images_uploader view hierarchy (such as wrapped iOS UIViews) was touched.
