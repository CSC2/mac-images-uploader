...
//Rare exceptions to indicate a bug in the _mac_images_uploader code (Eg, function that a subclass should have implemented)
...
/**
 The base class for mac_images_uploader proxies.
 */
