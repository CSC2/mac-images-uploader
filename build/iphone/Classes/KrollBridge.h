...
@interface mac_images_uploaderObject : KrollCoverageObject {
#else
@interface mac_images_uploaderObject : KrollObject {
#endif
@private
...
extern NSString * mac_images_uploader$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	mac_images_uploaderObject *_mac_images_uploader;
    KrollObject* console;
	BOOL shutdown;
