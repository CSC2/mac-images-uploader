...
MAKE_SYSTEM_PROP(ACTIVITY,UImac_images_uploaderNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UImac_images_uploaderNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UImac_images_uploaderNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UImac_images_uploaderNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UImac_images_uploaderNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UImac_images_uploaderNativeItemContactAdd);
