...
//@interface mac_images_uploaderObject : NSObject
//@end

@interface mac_images_uploaderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mac_images_uploaderObject class]])
		{
			for (NSString *key in [[(mac_images_uploaderObject*)o modules] allKeys])
			{
